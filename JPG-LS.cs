...
namespace JPEG_LS
{
    class JPG_LS
    {
        ...
        {
            Console.WriteLine("Ime izvornog fajla koji se kompresuje - bmp");

            FileStream fileIn = new FileStream(Console.ReadLine() + ".bmp", FileMode.Open);
            ReadImageFile bmp = new ReadImageFile(fileIn);
            fileIn.Close();

            Console.WriteLine("Ime kompresovanog izlaznog fajla - jls");
            ...
            compress.Compressing(bmp.data, ++(bmp.count), strOut, bmp.bmpinfo.biHeight, bmp.bmpinfo.biWidth);
            timer.Stop();
            Console.WriteLine("Vreme koje je potrebno da se izvrsi komperesija je :");
        ...
        {
            Console.WriteLine("Ime izvornog fajla koji se dekompresuje - jls");
            ...
            timer.Stop();
            Console.WriteLine("Vreme koje je potrebno da se izvrsi dekompresija je :");
            Console.WriteLine(timer.Elapsed);

            Console.WriteLine("Ime dekompresovanog izlaznog fajla - bmp");
