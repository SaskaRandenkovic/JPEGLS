...
namespace JPEG_LS
{
    public class Other
    {
        ...
        public double EdgeDetectingPredictor(double Ra, double Rb, double Rc)
        {
            double Px;
        ...
        public int FunctionMappingVector(int Q1, int Q2, int Q3)
        {
            int Q;
            if (Q1 == 0)
            {
        ...
        {
            //  Podrazumevane vrednosti MAXVAL = 255, NEAR = 0
